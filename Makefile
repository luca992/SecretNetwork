...
build-localsecret:
	docker build --build-arg BUILD_VERSION=${VERSION} --build-arg SGX_MODE=SW --build-arg FEATURES="${FEATURES},debug-print" --build-arg FEATURES_U="${FEATURES_U}" -f deployment/dockerfiles/base.Dockerfile -t rust-go-base-image .
